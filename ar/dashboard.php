                ...
                <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                if(!empty($thelatesttuser)){//if not empty show all data
                                    ...
                                    echo '<div class="alert alert-info nice-message">
                                            Sorry There Is No Recored To Show</div>';
                                }
                                ?>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <span class="glyphicon glyphicon-user"></span>
                                Latest <?php echo $latestteacher?> Registerd Teachers
                                <span class="pull-right toggle-info">
                                    <span class="glyphicon glyphicon-plus"></span>
                                </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                </span> Latest <?php echo $lateststudent ?> Registerd Student
                                <span class="pull-right toggle-info">
                                    <span class="glyphicon glyphicon-plus"></span>
                                </span>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <span class="glyphicon glyphicon-user"></span>
                                Latest <?php echo $latestclasses?> Registerd Classes
                                <span class="pull-right toggle-info">
                                    <span class="glyphicon glyphicon-plus"></span>
                                </span>
                            </div>
