<?php
    ...
    if(isset($_SESSION['username'])){// if there is session registerd with username
        $pagetitle = 'Members'; // set page title
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        <input type="text" value="<?php echo $row['UserName'];?>"
                               ...
                               autocomplete="off" placeholder="User Name To Enter To Dashboard"/>
                    </div>
                </div>
                <!-- end user name field -->
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        <input type="text" value="<?php echo $row['FullName'];?>"
                               ...
                               autocomplete="off" placeholder="Full Name That Appear in Dashboard"/>
                    </div>
                </div>
                <!-- end user full field -->
                <!-- start Email field -->
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        <input type="email" value="<?php echo $row['Email'];?>"
                               ...
                               autocomplete="off" placeholder="Eail of User"/>
                    </div>
                </div>
                <!-- end Email field -->
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        ...
                        <input type="password" name="newpass" class="form-control"
                               autocomplete="new-password" placeholder="Leave This Blank If you Do Not Want To change"/>
                    </div>
                </div>
                <!-- end password field -->
                <!-- start submit button -->
    ...
    <?php
               ...
               $msg = '<div class="alert alert-danger error">There Is No Such ID</div>';
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){// check if user coming throug post request
            ...
            if(strlen($user_name)<4){//if user name less than 4 chars store this message in array
                $formerror[] = 'User Name Can Not Be Less Than 4 Characters';
            }
            if(strlen($user_name)>20){//if user name is large than 20 chars store this message in array
                $formerror[] = 'User Name Can Not Be Greater Than 20 Characters';
            }
            ...
            <form class="form-horizontal" action="?do=Insert" method="POST">
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        ...
                        required="required" autocomplete="off" placeholder="FullName"/>
                    </div>
                </div>
                <!-- end Full name -->
                <!-- start Email -->
                ...
                <div class="form-group form-group-lg">
                    ...
                    <div class="col-sm-10 col-md-6">
                        ...
                        required="required" autocomplete="new-password" placeholder="Password"/>
    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){//insert page check if user coming through post request
            ...
            $msg = '<div class="alert alert-danger error">You Can Not Browse This Page Directly</div>';
            ...
            if ($check == 1) {// if greater than one the mean that user id is exists
                ...
                $msg = '<div class="alert alert-danger">Sorry This ID Not Exist</div>';
                redirect($msg); //redirect user to login page
            }
            echo '</div>';
    }
