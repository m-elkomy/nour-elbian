<?php
    ...
    if(isset($_SESSION['username'])){//check that session is set with this username
        $pagetitle = 'Branches'; // set page title
        ...
        if($do == 'Manage'){ // manage page
            ...
            ?>
            <h1 class="text-center">Manage Branch</h1>
                <!-- start container -->
            <div class="container">
        ...
        <?php
                    ...
                    <form class="form-horizontal"  action="?do=Insert" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-md-6 col-sm-1o">
                                <input type="text" name="B_Name" required="required"
                                       class="form-control" placeholder="Branch Name" autocomplete="off"/>
                            </div>
                        </div>
                        <!-- end branch name -->
                        <!-- start submit button -->
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){// check that user coming through post request
                echo '<h1 class="text-center">Insert Branch</h1>';
                echo '<div class="container">';
                ...
                if(!empty($br_name)){//if branch name not empty execute query
                    ...
                    if($check == 1){//check if branch name is exist
                        $msg = '<div class="alert alert-danger">Sorry This Name Is Exist</div>';
                    ...
                    $msg = '<div class="alert alert-danger">Sorry You Can Not Leave Branch Name Empty</div>';
                    redirect($msg,'back');//redirect to previous page
                }
                echo '</div>';
            }else{//if user not coming to this page usin post request
                $msg = '<div class="error alert alert-danger">Sorry You Can Not Browse This Page Directly</div>';
